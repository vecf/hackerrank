...
set incsearch
set infercase
set makeprg=make\ run1
set nomodeline
set operatorfunc=<SNR>25_go
set printoptions=paper:a4
set ruler
set runtimepath=~/.vim,~/.vim/pack/minpac/start/vim-unimpaired,~/.vim/pack/minpac/start/vim-textobj-user,~/.vim/pack/minpac/start/vim-textobj-entire,~/.vim/pack/minpac/start/vim-dispatch,~/.vim/pack/minpac/start/vim-commentary,~/.vim/pack/minpac/start/fzf,~/.vim/pack/bundle/start/vim-projectionist,~/.vim/pack/minpac/opt/minpac,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set shiftwidth=2
set showcmd
set smartcase
set softtabstop=2
...
silent only
silent tabonly
cd ~/Documents/personal/learning/cpp/hackerrankcolab
...
exe 'vert 1resize ' . ((&columns * 66 + 75) / 150)
exe '2resize ' . ((&lines * 11 + 18) / 37)
exe 'vert 2resize ' . ((&columns * 83 + 75) / 150)
exe '3resize ' . ((&lines * 22 + 18) / 37)
exe 'vert 3resize ' . ((&columns * 59 + 75) / 150)
exe '4resize ' . ((&lines * 22 + 18) / 37)
exe 'vert 4resize ' . ((&columns * 90 + 75) / 150)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let s:l = 29 - ((10 * winheight(0) + 5) / 11)
...
wincmd w
argglobal
if bufexists("solution.cpp") | buffer solution.cpp | else | edit solution.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 23 - ((5 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 60 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
